...
\begin{figure}[h]
  \centering
  \includegraphics[width=.8\linewidth]{images/sentiment_comparison_70.png}
  \caption{Aggregated sentiment for 70 randomly sampled speeches. Meloni's speeches in red, De Gasperi's speeches in blue.}
  \label{fig:sentiment_comparison}
\end{figure}

\subsection{Critiques and Future Work}
