...
All the code used to compute the results shown in this section can be seen in the jupyter notebook \href{https://github.com/mhetacc/crossdem/blob/c8f677e7a3a06ddcf2b7fdf29a825f2f27217637/notebooks/text_analysis.ipynb}{mhetacc/crossdem/notebooks/text\_analysis.ipynb}.
...
Of the top-1000 words, 478 are in common, with a Jaccard similarity of $32.19\%$.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.8\linewidth]{images/visual_top1k.png}
  \caption{t-SNE for top-1000 words for both PMs. In red Meloni-only words, in blue De Gasperi-only words, and in purple shared words.}
