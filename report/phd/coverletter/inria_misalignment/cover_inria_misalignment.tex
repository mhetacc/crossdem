...
\textbf{My background and research interests directly align with the project's objectives and directions:} the Master's Thesis I am working on (more details in the next section) requires me to do both data collection and data analysis using natural language processing tools and pipelines. I am compiling a corpus of political speeches, which are often ambiguous and open to different interpretations. This makes them a relevant case study to observe meaning-related misunderstandings.
