...
This is why I ultimately chose to gather a corpus of *external speeches* rather than internal ones. Large language models are trained with tokenizers, and the resulting token distribution is highly imbalanced: Chung et al. @chung_exploiting_2025 controlled study scaled the vocabulary of the language model from $24,000$ to $196,000$ tokens while holding data, computation, and optimization unchanged. They discovered that models are disproportionately optimized on the part of language that occur most frequently, meaning they are far better at understanding words and patterns that appear more often. This implies that internal speeches are less understandable to AI agents. 
...
Let us now shift the *focus on the analyses* themselves. \
// textual complexity
